...
int main() {
   ...
   sprite1 = boost::shared_ptr<PhysicalSprite<Box2dPhysics> >(
      new PhysicalSprite<Box2dPhysics>(internString("sprite1"), internString("shape"), tex0, EntityPhysics::options_t(false, false, 1.f, 0.3f))
   );
   ...
   sprite2 = boost::shared_ptr<PhysicalSprite<Box2dPhysics> >(
      new PhysicalSprite<Box2dPhysics>(internString("sprite2"), internString("shape"), tex1, EntityPhysics::options_t(true, false, 1.f, 0.3f))
   );
